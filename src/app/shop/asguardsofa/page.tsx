        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-gray-600">
              Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound&apos;s clarity.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4">
               <p className="text-gray-600">
                Embodying the row, wayward spirit of rock n&apos; roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound of Marshall, unplugging the chords, and takes the show on the road.
               </p>
            </div>
            <div className="p-4">
              <p className="text-gray-600">
                Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. Its analogue knobs allow you to fine-tune the controls to your personal preferences, while the guitar-influenced leather strap enables easy and stylish travel.
              </p>
            </div>
          </div>
        </div>
